...
from data_utils import ClassificationData, NIAData
...
def train_one_epoch(device, model, train_loader, optimizer):
	...
	for i, train_data in enumerate(train_loader):
		points, target = train_data['data'], train_data['label']
		target = target
...
def options():
	...
	parser.add_argument('--exp_name', type=str, default='NIA(공예,조각,건축,악기)_test', metavar='N',
	...
	parser.add_argument('--pretrained', default='pretrained/exp_classifier/models/best_model.t7', type=str,
...
def main():
	...
	#! NIA dataset loader
	trainset = NIAData(loadbool=True, train=True, load=True)
